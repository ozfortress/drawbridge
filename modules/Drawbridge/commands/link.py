...
class LinkModal(discord.ui.Modal, title='Link Account'):
    profile = discord.ui.String(label='Please link your Ozfortress Profile', placeholder='https://ozfortress.com/users/...')
    ...
    team = discord.ui.String(label='Please link your Team', placeholder='https://ozfortress.com/team/...')
...
class Link(discord_commands.Cog):
    ...
    @discord_commands.command(name='link', help='Link your Citadel account with your Discord account.')
